...
class EmbedController extends AbstractController
{
    ...
    #[Route('/circular-economy-projects/documentation.html', name: 'circular_economy_projects_documentation')]
    public function circularEconomyProjectsDocumentation(string $host, string $instanceId): Response
    {
        $converter = new GithubFlavoredMarkdownConverter([
            'html_input' => 'strip',
            'allow_unsafe_links' => true,
        ]);
        $markdown = file_get_contents(__DIR__.'/../../documentation/circular-economy-projects-embed.md');
        $markdown = str_replace('%HOST%', $host, $markdown);
        $markdown = str_replace('%INSTANCE_ID%', $instanceId, $markdown);

        return $this->render('embed/documentation.html.twig', [
            'title' => $instanceId.'CircularEconomyProjects Documentation',
            'documentation' => $converter->convert($markdown),
        ]);
    }

    #[Route('/iframe/circular-economy-projects-{_locale}.html', name: 'iframe_circular_economy_projects')]
    public function iframeCircularEconomyProjects(): Response
    {
    ...
    #[Route('/financial-supports/documentation.html', name: 'financial-supports_documentation')]
    public function financialSupportsDocumentation(string $host, string $instanceId): Response
    {
        $converter = new GithubFlavoredMarkdownConverter([
            'html_input' => 'strip',
            'allow_unsafe_links' => true,
        ]);
        $markdown = file_get_contents(__DIR__.'/../../documentation/financial-supports-embed.md');
        $markdown = str_replace('%HOST%', $host, $markdown);
        $markdown = str_replace('%INSTANCE_ID%', $instanceId, $markdown);

        return $this->render('embed/documentation.html.twig', [
            'title' => $instanceId.'FinancialSupports Documentation',
            'documentation' => $converter->convert($markdown),
        ]);
    }

    #[Route('/iframe/financial-supports-{_locale}.html', name: 'iframe_financial-supports')]
    public function iframeFinancialSupports(): Response
    {
    ...
    public function FeedbackDocumentation(string $host, string $instanceId): Response
    {
        ...
        $markdown = file_get_contents(__DIR__.'/../../documentation/feedback-embed.md');
        $markdown = str_replace('%HOST%', $host, $markdown);
        $markdown = str_replace('%INSTANCE_ID%', $instanceId, $markdown);

        return $this->render('embed/documentation.html.twig', [
            'title' => $instanceId.'Feedback Documentation',
            'documentation' => $converter->convert($markdown),
        ]);
    }

    #[Route('/iframe/feedback-{_locale}.html', name: 'iframe_feedback')]
    public function iframeFeedback(): Response
    {
        return $this->render('embed/iframe/feedback.html.twig', []);
    }
